...
FLAGS._parse_flags()
print("\nSummary of Parameters for Training:")
...
##Check whether we load a pretrained model or not
if USE_PRETRAINED_MODEL == False:
    ...
    for line in new_negative:
        if neg < 1000000:
            ...
            train_dataset.append(line)
            neg = neg + 1
    print("Total Positive Tweets:", neg)

    print("Total number of Tweets:", len(train_dataset))
    ...
    train_dataset_final = []
    for i in indexes:
        train_dataset_final.append(train_dataset[i])
    train_dataset_final = train_dataset_final[0:200000]
    train_labels = train_labels[0:200000]

    # Data Preparation
    print("Loading data...")
    x_text = train_dataset_final
    ...
    with tf.Graph().as_default():
        ...
        with sess.as_default():
            ...
            def train_step(x_batch, y_batch):
                ...
                print(
                    "{}: step {}, learning_rate {:g}, loss {:g}, acc {:g} ".format(time_str, step, learning_rate, loss,
                                                                                   accuracy))
